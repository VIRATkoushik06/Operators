...
Ans:
'''
def calculate_total_contribution(senior_salary, junior_salary):
    # Number of players
    senior_players = 6
    junior_players = 5
    ...
    # Total contributions
    senior_contribution = senior_salary * senior_players * senior_contribution_rate
    junior_contribution = junior_salary * junior_players * junior_contribution_rate
...
# Main program
# Input values
senior_salary = int(input("Enter salary of senior players (Rs): "))
junior_salary = int(input("Enter salary of junior players (Rs): "))

# Calculate total contribution
total_amount = calculate_total_contribution(senior_salary, junior_salary)
